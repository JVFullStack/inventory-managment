...
export default function CardPurchaseSummary() {
  ...
  const purshaceData = data?.purchaseSummary || [];

  const lastDataPoint = purshaceData[purshaceData.length - 1] || null;
  console.log(lastDataPoint?.changePercentage);
          ...
          <div className="">
            <div className="mb-4 mt-7 px-7">
              ...
              <div className="flex items-center">
                ...
                {lastDataPoint && (
                  <p
                    className={cn("text-sm text-red-500 flex ml-3", {
                      "text-green-500":
